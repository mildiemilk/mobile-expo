...
import {
	...
	signOut, 
	registerWithEmail, 
	addUserToDatabaseAndStore} from '../lib/handlers/authenticator'
...
class Register extends React.Component {
	async componentDidMount() {
		...
		if(loginUser.user) {
			await addUserToDatabaseAndStore(
				loginUser.additionalUserInfo.profile.id, 
				loginUser.credential.accessToken, 
				loginUser.user.displayName, 
				loginUser.user.uid, loginUser.user.email
			)
		}
