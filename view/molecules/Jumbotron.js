...
const ImageHomeContent = isMobile => {
	return (<div style={{ width: isMobile?'100%':'40%', position: 'relative', height: '400px' }}>
		<img style={{ width: '300px', position:isMobile?'relative': 'absolute', right: isMobile?'0':'-50px', top: '0' }} src='https://firebasestorage.googleapis.com/v0/b/sharemai-1.appspot.com/o/cover-page%2Ffrontpagephoto.png?alt=media&token=6d5960c7-6cdc-4879-a491-4f54871f7ff7' alt="เวปที่จะเปลี่ยนแปลงชีวิตคุณ" />
	</div>)
}
