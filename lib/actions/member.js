...
export const SET_MEMBERSHIP_FROM_MEMBER_BY_EMAIL = 'SET_MEMBERSHIP_FROM_MEMBER_BY_EMAIL'
export const setMembershipFromMemberByEmail = membershipArray => ({type:SET_MEMBERSHIP_FROM_MEMBER_BY_EMAIL, payload:membershipArray})

export const SET_ALL_MEMBERSHIPS = asyncaction('SET_ALL_MEMBERSHIPS')
export const setAllMembershipsPending = () => ({type:SET_ALL_MEMBERSHIPS.PENDING})
export const setAllMembershipsSuccess = memberships => ({type:SET_ALL_MEMBERSHIPS.SUCCESS, payload: memberships })
export const setAllMembershipsError = msg => ({type:SET_ALL_MEMBERSHIPS.ERROR, payload:msg})
