...
export const updateChatroomMessageSuccess = chatroom => ({ type: UPDATE_CHATROOM_MESSAGE.SUCCESS, payload:chatroom})

export const SET_CHAT = asyncaction('SET_CHAT')
export const setChats = chats => ({ type: SET_CHAT.SUCCESS, payload:chats})