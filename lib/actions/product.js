...
export const SET_PRODUCT_SUB_IMAGE = asyncaction('SET_PRODUCT_SUB_IMAGE')
export const setProductImage = (image, key) => ({type: SET_PRODUCT_SUB_IMAGE.SUCCESS, payload:{image, key}})
