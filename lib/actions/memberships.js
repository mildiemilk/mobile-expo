...
export const SET_NEW_MEMBERSHIP_PASSWORD = asyncaction('SET_NEW_MEMBERSHIP_PASSWORD')
export const setNewMembershipPasswordPending = () =>({type:SET_NEW_MEMBERSHIP_PASSWORD.PENDING})
export const setNewMembershipPasswordSuccess = () => ({type:SET_NEW_MEMBERSHIP_PASSWORD.SUCCESS})