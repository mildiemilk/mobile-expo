...
export const createPayment = async (amount, sellerUid, ownerUid) => {
	...
	//TODO save transcation 
	//TODO fetch the wallet
	let sellerWallet = await getWallet(sellerUid, 'productSeller')
	let ownerWallet = await getWallet(ownerUid, 'productOWner')
	console.log(sellerWallet)
	console.log(ownerWallet)
	//TODO update the wallet 
