...
export default (state = defaultTransaction, action) => {
	...
	switch(type) {
		case ADD_TRANSACTION:
			const { transactionId, comissionCash, comissionPercent, price, sellerId, buyerId, sponsorId, address1, address2, postalCode, city, email } = payload
		...
		case SET_PRODUCT_BY_ID.SUCCESS:
			return {
				...
				comissionPercent: payload.comissionPercent
			}
